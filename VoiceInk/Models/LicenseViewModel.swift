...
class LicenseViewModel: ObservableObject {
    ...
    @Published private(set) var licenseState: LicenseState = .licensed  // App is now free - always licensed
    ...
    init() {
        // App is free - always set to licensed state
        licenseState = .licensed
    }
    
    func startTrial() {
        // App is free - no trial needed, always licensed
        licenseState = .licensed
    ...
    private func loadLicenseState() {
        ...
        // Still check for existing license key to maintain compatibility with previous installations
    ...
    var canUseApp: Bool {
        // App is free - always return true
        return true
    }
    ...
    func removeLicense() {
        ...
        // App is free - always remain licensed
        licenseState = .licensed
        licenseKey = ""
